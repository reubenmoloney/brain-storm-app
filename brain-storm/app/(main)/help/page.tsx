  ...
  return ( 
      <div className = "relative flex bg-slate-50">
          <div className = "fixed pt-[3%] w-[10%] mb-[30px] mr-[50px] ml-[1%]">
              <div className = "hover:underline decoration-red-300 py-[3%]"><a href="#register">Register</a></div>
              <div className ="hover:underline decoration-red-300 py-[3%]"><a href="#login">Login</a></div>
              <div className ="hover:underline decoration-red-300 py-[3%]"><a href="#navigation">Navigation</a></div>
              <div className ="hover:underline decoration-red-300 py-[3%]"><a href="#create group">Create Group</a></div>
              <div className ="hover:underline decoration-red-300 py-[3%]"><a href="#add members">Add Members</a></div>
              <div className ="hover:underline decoration-red-300 py-[3%]"><a href="#remove members">Remove Members</a></div>
              <div className ="hover:underline decoration-red-300 py-[3%]"><a href="#change roles">Change Roles</a></div>
              <div className ="hover:underline decoration-red-300 py-[3%]"><a href="#create topics">Create Topic</a></div>
              <div className ="hover:underline decoration-red-300 py-[3%]"><a href="#write messages">Write Messages</a></div>
              <div className ="hover:underline decoration-red-300 py-[3%]"><a href="#uploading files">Uploading Files</a></div>
              <div className ="hover:underline decoration-red-300 py-[3%]"><a href="#creating files">Voice and Video Call</a></div>
              <div className ="hover:underline decoration-red-300 py-[3%]"><a href="#leave a group">Leave a Group</a></div>
              <div className ="hover:underline decoration-red-300 py-[3%]"><a href="#join groups">Join Groups</a></div>
              <div className ="hover:underline decoration-red-300 py-[3%]"><a href="#manage account">Manage Account</a></div>
              <div className ="hover:underline decoration-red-300 py-[3%]" ><a href="#signout">Sign Out</a></div>   
          </div>
          <div className = "bg-white ml-[15%] mb-[30px] w-[100%]">
              <div className="py-[3%] px-[3%]"><a id = "register" style = {{display:'block', position: 'relative', top: '-100px', visibility:'hidden'}}></a><p className = "text-xl mb-[20px]">Register</p>
            ...
            <br/><br/>
                <hr/>
              <div className= "py-[3%] px-[3%]'"><a id = "login" style = {{display:'block', position: 'relative', top: '-100px', visibility:'hidden'}}></a><p className = "text-xl mb-[20px]">login</p><p className="ml-[3%]">
              ...
              <hr/>
              <div className="py-[3%] px-[3%]"><a id = "navigation" style = {{display:'block', position: 'relative', top: '-100px', visibility:'hidden'}}></a><p className = "text-xl mb-[20px]">navigation</p><p className="ml-[3%]"> 
...
<br/><br/><div className={'drop-shadow-md'}><Image src="/help/side-bar.png" width={150} height ={500} alt ="side bar"/></div></p></div>
              <hr/>
              <div className= "py-[3%] px-[3%]"><a id = "create group" style = {{display:'block', position: 'relative', top: '-100px', visibility:'hidden'}}></a><p className = "text-xl mb-[20px]">create group</p><p className="ml-[3%]">Groups are the home of your projects. It is within groups that you can collaborate with friends and colleagues. <br/>
              <br/>
              <ol>
              ...
              <hr/>
              <div className= "py-[3%] px-[3%]"><a id = "add members" style = {{display:'block', position: 'relative', top: '-100px', visibility:'hidden'}}></a><p className = "text-xl mb-[20px]">add members</p><p className="ml-[3%]">
              ...
              <hr/>
              <div className="py-[3%] px-[3%]"><a id = "remove members" style = {{display:'block', position: 'relative', top: '-100px', visibility:'hidden'}}></a><p className = "text-xl mb-[20px]">remove members</p><p className="ml-[3%]">
                <ol>
              ...
              <hr/>
              <div className="py-[3%] px-[3%]"><a id = "create topics" style = {{display:'block', position: 'relative', top: '-100px', visibility:'hidden'}}></a><p className = "text-xl mb-[20px]">create topic</p><p className="ml-[3%]">
              ...
              <hr/>
              <div className="py-[3%] px-[3%]"><a id = "write messages" style = {{display:'block', position: 'relative', top: '-100px', visibility:'hidden'}}></a><p className = "text-xl mb-[20px]">write messages</p><p className="ml-[3%]">
              ...
              <hr/>
              <div className="py-[3%] px-[3%]"><a id = "uploading files" style = {{display:'block', position: 'relative', top: '-100px', visibility:'hidden'}}></a><p className = "text-xl mb-[20px]">uploading files</p><p className="ml-[3%]">
              Files can be uploaded and shared within group topics. <br/><br/>
              <ol>
              ...
              <hr/>
              <div className="py-[3%] px-[3%]"><a id = "creating files" style = {{display:'block', position: 'relative', top: '-100px', visibility:'hidden'}}></a><p className = "text-xl mb-[20px]">Voice and Video Call</p><p className="ml-[3%]"> 
              Brainstorm allows users to join voice and video calls with other users in their group. The call feature within groups also allows users to share their screens.
              <br/><br/>
              <ol>
                <li style={{listStyle:'decimal'}}>In order to start a call, firstly you must navigate to the <b>My Groups</b></li>
                <li style={{listStyle:'decimal'}}>At the bottom of the topic pane within your group, select <b>Call</b></li>
              </ol>
              <br/><br/>
              <div className={'drop-shadow-md'}><Image src="/help/call.gif" width={500} height ={150} alt ="make a call"/></div><br/><br/>
              You are now in a call. From here you can select <b>Share screen</b> to share your screen, or <b>leave</b> to leave the call.
              </p></div>
              <hr/>
              <div className="py-[3%] px-[3%]"><a id = "leave a group" style = {{display:'block', position: 'relative', top: '-100px', visibility:'hidden'}}></a><p className = "text-xl mb-[20px]">leave a group</p><p className="ml-[3%]">
              <ol>
              ...
              <hr/>
              <div className="py-[3%] px-[3%]"><a id = "join groups" style = {{display:'block', position: 'relative', top: '-100px', visibility:'hidden'}}></a><p className = "text-xl mb-[20px]">join groups</p><p className="ml-[3%]">
              ...
              <hr/>
              <div className="py-[3%] px-[3%]"><a id = "manage account" style = {{display:'block', position: 'relative', top: '-100px', visibility:'hidden'}}></a><p className = "text-xl mb-[20px]">manage account</p><p className="ml-[3%]"> 
              ...
              <hr/>
              <div className="py-[3%] px-[3%]"><a id = "signout" style = {{display:'block', position: 'relative', top: '-100px', visibility:'hidden'}}></a><p className = "text-xl mb-[20px]"> sign out</p><p className="ml-[3%]"> 
